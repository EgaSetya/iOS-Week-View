...
UICollectionViewDelegate, UICollectionViewDataSource, DayViewCellDelegate, FrameCalculatorDelegate {
    ...
    public var isUsingPlainEvent = false
    ...
    var prevScrollViewOffsetX = CGFloat(0)
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if scrollView.isTracking || scrollView.isDragging{
            if prevScrollViewOffsetX == 0.0{
                prevScrollViewOffsetX = scrollView.contentOffset.x
            }else{
                dayCollectionView.contentOffset.x = prevScrollViewOffsetX
            }
        }
